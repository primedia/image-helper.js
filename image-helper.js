...
(function() {
  define(['jquery'], function($) {
    var assetHostMetaKey, assetURL, currentServerIndex, isInvalidURL, notFoundImageWidth, notFoundPath, notFoundURL, pickServer, servers, serversMetaKey, setNotFoundImageWidth, setNotFoundPath, url, _contentFromMeta, _notFoundImageWidth;
    ...
    notFoundImageWidth = function() {
      return _notFoundImageWidth;
    };
    setNotFoundImageWidth = function(width) {
      return _notFoundImageWidth = width;
    };
    return {
